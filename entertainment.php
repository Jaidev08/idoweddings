...
#citieswithlines span:after {
  ...
  margin-bottom: 5px;
    ...
    <title>iDo Weddings - Wedding Entertainment</title>
            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ol>
                        ...
                        <li><a href="dancemusic.php">Dance & Music</a></li>
    ...
    <section id="chefs" class="chefs">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Dance & Music</h2>
                <p>Some of Our Wedding Entertainment Vendors</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="100">
                        <img src="assets/img/entertainment/ent1.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>Daksh - The Band</h4>
                                <span>Mulund West, Mumbai</span>
                            </div>
                            <div class="social">
                                <i class="bi">Package Starting Price : ₹ 75,000 </i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="200">
                        <img src="assets/img/entertainment/ent2.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>Anchor Amol Nile</h4>
                                <span>Ghatkopar, Mumbai</span>
                            </div>
                            <div class="social">
                            <i class="bi">Package Starting Price : ₹ 40,000 </i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="300">
                        <img src="assets/img/entertainment/ent3.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>Anchor Aman Malhotra</h4>
                                <span>Thane West, Mumbai</span>
                            </div>
                            <div class="social">
                            <i class="bi">Package Starting Price : ₹ 25,000 </i>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="100">
        <img src="assets/img/entertainment/ent4.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>The Band of Gunjan</h4>
                <span>Punjabi Bagh East, New Delhi</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 1,00,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="200">
        <img src="assets/img/entertainment/ent5.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Aawaz - The Band</h4>
                <span>Jasola, New Delhi</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 1,00,000 </i>
            </div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="300">
        <img src="assets/img/entertainment/ent6.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Anchor Sagar Duggal</h4>
                <span>Dwarka, Delhi</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 20,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="100">
        <img src="assets/img/entertainment/ent7.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Beat Gurus</h4>
            ...
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 1,50,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="200">
        <img src="assets/img/entertainment/ent8.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>MC Gokul</h4>
            ...
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 30,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="300">
        <img src="assets/img/entertainment/ent9.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Ginny & The Bottle</h4>
                <span>Electronic City, Bengaluru</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 2,00,000 </i>
            </div>
        </div>
    </div>
</div>
