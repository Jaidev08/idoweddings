...
outline: 0;
    ...
    <title>iDo Weddings - The Holiday Inn</title>
                    ...
                    <form action="" method="post"  data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="row">
                            <div class="col-lg-6 order-1 order-lg-1" data-aos="zoom-in" data-aos-delay="100">
                                <div class="about-img">
                                    <img src="assets/img/halls/holidayinnmumbai.jpg" alt="" />
                                </div>
                                <div>
                         <label class="price" style="margin-top:50px; margin-left:150px">Price per Plate : Rs.2000</label>
                                </div>
                                <br />

                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-2 content">
                                <h3>The Holiday Inn</h3>
                                <?php echo $success;?>
                                ...
                                <div class="col-md-12 form-group">
                                        <input type="text" name="hall" class="form-control" value="The Holiday Inn" readonly  id="formbanquets1">
                                    </div><br></br>
                                    ...
                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                        ...
                                        <input type="text" name="price_per_plate" class="form-control" value="2000" readonly   id="formbanquets">
                                    </div><br><br />
