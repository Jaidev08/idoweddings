...
#citieswithlines span:after {
  ...
  margin-bottom: 5px;
    ...
    <title>iDo Weddings - Choreographers</title>
    ...
    <section id="chefs" class="chefs">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Dance</h2>
                <p>Some of Our Professional Choreographers</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="100">
                        <img src="assets/img/choreo/choreo1.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="200">
                        <img src="assets/img/choreo/choreo2.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>ChoreoFunk Entertainment</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="300">
                        <img src="assets/img/choreo/choreo3.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>Raahil Dance Team</h4>
                                <span>Mira, Mumbai</span>
                            </div>
                            <div class="social">
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="100">
        <img src="assets/img/choreo/choreo4.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Choreo N Concept</h4>
                <span>Gurugram, Delhi NCR</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 7,500 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="200">
        <img src="assets/img/choreo/choreo5.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>On Pointe</h4>
                <span>Peeragarhi - Paschim Vihar, West Delhi</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 10,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="300">
        <img src="assets/img/choreo/choreo6.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Right Move - Wedding Choreographers</h4>
                <span>Saket - Malviya Nagar, South Delhi</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 35,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="100">
        <img src="assets/img/choreo/choreo7.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>PPDC Weddings</h4>
                <span>Thanisandra, Bengaluru</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 35,000 </i>
            </div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="200">
        <img src="assets/img/choreo/choreo8.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>H20 Studioz!</h4>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="300">
        <img src="assets/img/choreo/choreo9.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Bangalore Thumakda</h4>
                <span>NR Orchid Gardenia, Bengaluru</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 70,000 </i>
            </div>
        </div>
    </div>
</div>
