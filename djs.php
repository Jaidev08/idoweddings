    ...
    <section id="chefs" class="chefs">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Music</h2>
                <p>Some of Our Professional DJs</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="100">
                        <img src="assets/img/djs/dj1.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="200">
                        <img src="assets/img/djs/dj2.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>DJ Toons</h4>
                                <span>Andheri West, Mumbai</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="300">
                        <img src="assets/img/djs/dj3.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>DJ Shilpi Sharma</h4>
                                <span>Andheri East, Mumbai</span>
                            </div>
                            <div class="social">
                            <i class="bi">Package Starting Price : ₹ 2,50,000 </i>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="100">
        <img src="assets/img/djs/dj4.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>DJ Sumit Sethi</h4>
                <span>Model Town, Delhi</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 3,00,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="200">
        <img src="assets/img/djs/dj5.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>DJ Sukhbir</h4>
                <span>Delhi NCR</span>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="300">
        <img src="assets/img/djs/dj6.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>Basspatch</h4>
                <span>Karol Bagh, Delhi NCR</span>
            </div>
            <div class="social">
            <i class="bi">Package Starting Price : ₹ 50,000 </i>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="100">
        <img src="assets/img/djs/dj7.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>DJ NShyap</h4>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="200">
        <img src="assets/img/djs/dj8.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>DJ Shine HVK</h4>
...
<div class="col-lg-4 col-md-6">
    <div class="member" data-aos="zoom-in" data-aos-delay="300">
        <img src="assets/img/djs/dj9.jpg" class="img-fluid" alt="">
        <div class="member-info">
            <div class="member-info-content">
                <h4>DJ Jasmeet</h4>
