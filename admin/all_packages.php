...
<head>
    ...
    <title>iDo Weddings - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
         ...
         <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src=""  class="dark-logo"/><span style="color:#6164ff; font-weight:bold;">iDo Weddings</span>
                    </a>
                </div>
                <!-- End Logo -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fas fa-briefcase"></i><span class="hide-menu">Bookings</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_bookings.php">Banquet Hall Bookings</a></li>
                                <li><a href="all_packages.php">Package Bookings</a></li>                                
                            </ul>
                        </li>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			<?php
																					echo ' <tr>
                                                                                            ...
                                                                                            <td>'.$rows['email'].'</td>
                                                                                            <td>'.$rows['select_location'].'</td>
                                                                                            <td>'.$rows['package_type'].'</td>
                                                                                            <td>'.$rows['date_of_package'].'</td>
