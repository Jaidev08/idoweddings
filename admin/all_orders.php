																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																			...
																			if($payment_mode=="" or $payment_mode=="NULL")
																			{
																			?>
																			<td> <button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars"  aria-hidden="true" >not selected</button></td>
																		   <?php 
																			  }
																			   if($payment_mode=="cod")
																			 { ?>
																			<td> <button type="button" class="btn btn-warning"><span class="fa fa-check-circle"  aria-hidden="true" ></span> cod</button></td> 
                                                                            <?php 
																			  }
																			   if($payment_mode=="takeaway")
																			 { ?>
																			<td> <button type="button" class="btn btn-danger"><span class="fa fa-check-circle"  aria-hidden="true" ></span> takeaway</button></td> 
																			<?php
																				}
																			if($payment_mode=="online")
																				{
																			?>
																			<td> <button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true"> online</button></td> 
																			<?php 
																			} 
																			?>
																			<?php
																			if($payment_mode=="rejected")
																				{
																			?>
