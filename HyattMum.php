                         ...
                         <label class="price" style="margin-top:50px; margin-left:150px">Price per Plate : Rs.3700</label>
                            ...
                            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-2 content">
                                ...
                                <div class="col-md-12 form-group">
                                        <input type="text" name="hall" class="form-control" value="The Grand Ballroom" readonly  id="formbanquets1">
                                    </div><br></br>
                                    ...
                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                        <input type="number" name="no_of_guests" class="form-control" placeholder="Number Of Guests" id="formbanquets" min="50" max="3700" required>
                                    </div><br><br />
                                    ...
                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                        ...
                                        <input type="text" name="price_per_plate" class="form-control" value="3700" readonly   id="formbanquets">
                                    </div><br><br />
